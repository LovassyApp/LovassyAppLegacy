...
const Login = () => {
    ...
    const onRememberToggle = () => {
        ...
        const msg = newVal
            ? "Jó döntés, ifjú padavan."
            : "Azt ugye tudod, hogy fél óra múlva ki leszel rakva innen?";
        setRemember(newVal);
        toast(msg, {
    ...
    return (
        <BaseLogin>
            <form onSubmit={(e) => handleClick(e)}>
                ...
                <Alert
                    color="danger"
                    isOpen={userIsVisible}
                    toggle={() => userSetVisible(false)}
                >
                    {userErr.map((el) => (
                        <span>
                            {" "}
                ...
                <Alert
                    color="danger"
                    isOpen={passIsVisible}
                    toggle={() => passSetVisible(false)}
                >
                    {passwordErr.map((el) => (
                        <span>
                            {" "}
