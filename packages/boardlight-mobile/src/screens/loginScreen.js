import { Button, Dialog, Headline, HelperText, Paragraph, Portal, Text, TextInput } from 'react-native-paper';
    ...
    const doLogin = async () => {
        ...
        try {
            ...
            if (err.response) {
                ...
                } else if (err.response.data.status === 'error' && err.response.data.type === 'AuthErrorException') {
                    setEmailError('');
            ...
            <View style={styles.container}>
                <KeyboardAvoidingView style={styles.form} behavior="position">
                    ...
                    <View style={styles.buttonRow}>
                        <LaButton customStyle={styles.rowBackButton} onPress={() => navigation.navigate('Register')}>
